...
/*   Updated: 2018/06/16 23:46:09 by dlaurent         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
/*
** Tous les adressages sont relatifs au PC et à IDX_MOD sauf pour:
** lld
** lldi
** lfork
** name, nb params, params type, id, nb_cycles, denomination, ocp,
** a quoi correspond le dernier param ? ce n'est pas le carry 
*/
